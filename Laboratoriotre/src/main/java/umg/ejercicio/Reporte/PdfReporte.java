package umg.ejercicio.Reporte;
import com.itextpdf.text.*;
import com.itextpdf.text.pdf.PdfPCell;
import com.itextpdf.text.pdf.PdfPTable;
import com.itextpdf.text.pdf.PdfWriter;
import umg.ejercicio.Conexion.Conexion;
...
public class PdfReporte {
    ...
    private void addTitle(Document document) throws DocumentException {
        Paragraph title = new Paragraph("REPORTE DE PRODUCTOS\n" +
                "Estudiante: Daniela Maricler Guitz Palma, Carnet: 0905-23-15374",  TITLE_FONT);
    ...
    private void addRowsGroup(PdfPTable table, List<ProductoModel> productos) {
        ...
        try {
            ...
            PdfPTable table = new PdfPTable(3); // 3 columnas, puedes ajustarlo a las columnas de tu tabla
            ...
            String query = "SELECT id_producto, descripcion, origen FROM productos";
            ...
            while (resultSet.next()) {
                ...
                table.addCell(resultSet.getString("origen"));
            }
