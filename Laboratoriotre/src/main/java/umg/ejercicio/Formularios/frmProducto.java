...
import umg.ejercicio.Reporte.PdfReporte;
import umg.ejercicio.Service.ProductoService;
        ...
        buttonGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Error al guarder el producto: " + ex.getMessage());
                }
            }
        });
        ...
        buttonPDF.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (productos != null) {
                        new PdfReporte().generateProductReport(productos, "C:\\ReportePdf\\reporte.pdf", agrupados);
